...
.. _gradient_estimation:

Estimating gradients on quantum hardware
========================================

.. meta::
    :property="og:description": Get to know various ways to estimate gradients on quantum hardware.
...
.. related::
   ...
   spsa The Simultaneous Perturbation Stochastic Approximation optimizer

*Author: David Wierichs — Posted: xx November 2022. Last updated: xx November 2022.*

In this demo we look at different estimators for gradients on quantum hardware,
comparing their requirements and statistical properties.
